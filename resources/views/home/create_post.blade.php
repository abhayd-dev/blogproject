...
@endif
            ...
            <h3 class="text-dark font-weight-bold text-uppercase mt-3"> Create Post Here </h3>
            <hr class="text-dark"/>
        </div>
        <div class="text-dark forms">
        ...
        <div class="text-center">
        <button type="submit" class="btn  btni text-white">ADD POST</button>
    </div>
    <hr class="text-dark"/>
      </form>
        </div>
