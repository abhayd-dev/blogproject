        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#"
                        ...
                        class="nav-link language dropdown-toggle"><img src="admincss/img/india.png"
                            alt="English" height="10" width="10" class="img-fluid"><span class="d-none d-sm-inline-block">English</span></a>
                    <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#"
                            class="dropdown-item"> <img src="admincss/img/india.png" height="10" width="10"  alt="English"
                                class="mr-2"><span>Hindi</span></a><a rel="nofollow" href="#"
                            class="dropdown-item"> <img src="admincss/img/india.png" height="10" width="10"  alt="English"
                                class="img-sluid mr-2"><span>English </span></a></div>
                </div>
                <!-- Log out               -->
                <div class="list-inline-item logout">  <li class="nav-item dropdown" id="myuserbtn">
                  <a id="navbarDropdown" class="nav-link dropdown-toggle" href="" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                      {{ Auth::user()->name }}
                  </a>
   
                  <div class="dropdown-menu dropdown-menu-end w-20" aria-labelledby="navbarDropdown">
